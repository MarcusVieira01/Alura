...
def abertura():
    '''Descrição da função: Exibir mensagem de entrada'''
    print("*********************************")
...
def carrega_palavra_secreta():
    '''Descrição da função: carrega palavra secreta'''
    ...
    return palavras[indice].upper()


def jogar():
    '''Descrição da função jogar: Definição de função com a lógica do jogo de forca'''
    # Evoca o método de abertura
    abertura()

    # Evoca o método para definir a palavra secreta
    ...
    # Atribuição do valor de retorno da função
